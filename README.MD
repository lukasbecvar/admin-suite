...
* Download the latest prebuilt archive (`admin-suite-<tag>.tar.gz`) from the release assets: [GitHub Releases](https://github.com/lukasbecvar/admin-suite/releases) page and extract it on your server
